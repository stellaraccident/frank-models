...
// DBRX forward pass.
// Reference: llama.cpp llama-model.cpp:7384-7505 (llm_build_dbrx).
//
// Architecture: Simpler MoE variant with 16 experts (top-4 routing).
...
module @dbrx {
  ...
  util.func public @forward(
    ...
    // DBRX does not normalize expert weights.
